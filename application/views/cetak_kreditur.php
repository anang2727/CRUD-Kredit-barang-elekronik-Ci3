...
<input type="hidden" value="<?php echo $kreditur['NK'] ?>" name="NK">
                ...
                <div class="card pb-3">
                    <div class="tab-content pt-2">
                        ...
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <h5 class="card-title fw-bold text-center">KARTU KREDITUR</h5>
                            <p>Toko ABC Matang Glumpang Dua - Bireuen</p>
                            <div class="row ms-5 mb-2">
                                <div class="col-lg-6 col-md-4 label ">Nama Kreditur</div>
                                <div class="col-lg-6 col-md-8">:<?php echo $kreditur['NMK'] ?></div>
                            </div>

                            <div class="row ms-5 mb-2">
                                <div class="col-lg-6 col-md-4 label">Alamat Kreditur</div>
                                <div class="col-lg-6 col-md-8">:<?php echo $kreditur['AK'] ?></div>
                            </div>

                            <div class="row ms-5 mb-2">
                                <div class="col-lg-6 col-md-4 label">Pekerjaan</div>
                                <div class="col-lg-6 col-md-8">:<?php echo $kreditur['PEKER'] ?></div>
                            </div>

                            <div class="row ms-5 mb-2">
                                <div class="col-lg-6 col-md-4 label">No Hp </div>
                                <div class="col-lg-6 col-md-8">:<?php echo $kreditur['NO_HP'] ?></div>
                            </div>
    ...
    <?php echo anchor ('kreditur/pdf','Pdf',array('class' => ' btn btn-primary mb-3 bi bi-plus btn-sm'));?>
    <?php echo anchor ('kreditur/cetak','Print',array('class' => ' btn btn-warning mb-3 bi bi-plus btn-sm'));?>
