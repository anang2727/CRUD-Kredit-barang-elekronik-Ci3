...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <main id="main" class="main">
    ...
    <?php echo anchor ('uang_muka/tambah','Tambah',array('class' => ' btn btn-primary mb-3 bi bi-plus btn-sm'));?>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="card">
            <div class="card-body">
              <h5 class="card-title">Uang Muka</h5>
              ...
              <table class="table">
                <thead>
                  <tr>
                    <th scope="col">No</th>
                    <th scope="col">Kode Uang Muka</th>
                    <th scope="col">Jumlah Uang Muka</th>
        ...
        foreach ($record->result() as $r){
            ...
            <td width='2'>".anchor('uang_muka/edit/'.$r->KUA ,'<i class="bi bi-pencil"></i>',array('class' => 'btn btn-success btn-sm'))."</td>
            <td width='20'>".anchor('uang_muka/delete/'.$r->KUA,'<i class="bi bi-trash"></i>',array('class' => 'btn btn-danger btn-sm'))."</td>
            <tr>";
            $no++;
        }?>
                </tbody>
