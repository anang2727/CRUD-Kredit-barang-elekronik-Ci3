...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <?php
        echo form_open('uang_muka/edit');
        ?>
        <input type="hidden" value="<?php echo $record['KUA'] ?>" name="KUA">
        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <form>
                    ...
                    echo form_open('uang_muka/edit');
                    ?>
                    <input type="hidden" value="<?php echo $record['KUA'] ?>" name="id">

                    <!-- Kode Elektronik -->
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Jumlah Uang Muka</label>
                        <div class="col-sm-4">
                            <input type="text" name="UM" class="form-control" value="<?php echo $record['UM'] ?>">
                        </div>
                    </div>
