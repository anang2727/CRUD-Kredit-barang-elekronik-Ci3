...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        ?>
        <input type="hidden" value="<?php echo $record['KDP'] ?>" name="KDP">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h2 class="text-center fw-bold">#PEGAWAI</h2>
            <h1>Edit Pegawai</h1>
            <nav>
                <ol class="breadcrumb">
        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <form>
                    ...
                    echo form_open('pegawai/edit');
                    ?>
                    <input type="hidden" value="<?php echo $record['KDP'] ?>" name="id">

                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Nama Pegawai</label>
                        <div class="col-sm-4">
                            <input type="text" name="NP" class="form-control" value="<?php echo $record['NP'] ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Alamat Pegawai</label>
                        <div class="col-sm-4">
                            <input type="text" name="AP" class="form-control" value="<?php echo $record['AP'] ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">No Hp</label>
                        <div class="col-sm-4">
                            <select name="JK" id="JK" class="form-control" value="<?php echo $record['JK'] ?>">
                ...
                <div class="row mt-5">
                    <?php echo anchor('pegawai', '<i class="array(btn btn-primary bi bi-arrow-left-square-fill fs-3"></i>') ?>
                </div>
