...
<button class="btn btn-danger bi bi-file-earmark-pdf me-3">
  <?php echo anchor('pegawai/pdf', 'Pdf', array('class' => 'mb-3 text-light btn-sm')); ?>
</button>
<button class="btn btn-dark bi bi-printer me-3" onClick="window.print();">
  <?php echo anchor('pegawai', 'Print', array('class' => 'text-light btn-sm')); ?>
</button>

</div>
    <div class="pagetitle">
      <h2 class="text-center fw-bold">#DAFTAR PEGAWAI</h2>
      <h1>Dashboard</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <?php echo anchor('pegawai/tambah', 'Tambah', array('class' => ' btn btn-primary mb-3 bi bi-plus btn-sm')); ?>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <td>$no</td>
            <td>$r->KDP</td>
            <td scope=row>$r->NP</td>
            <td scope=row>$r->AP</td>
            <td scope=row>$r->NO_HP</td>
            <td scope=row>$r->JK</td>
            <td width='2'>" . anchor('pegawai/edit/' . $r->KDP, '<i class="bi bi-pencil"></i>', array('class' => 'btn btn-success btn-sm', 'title' => 'Edit ' . $r->NP)) . "</td>
            <td width='20'>" . anchor('pegawai/delete/' . $r->KDP, '<i class="bi bi-trash"></i>', array('class' => 'btn btn-danger btn-sm', 'title' => 'Hapus ' . $r->NP)) . "</td>
            <tr>";
                      $no++;
                    } ?>
                  </tbody>
