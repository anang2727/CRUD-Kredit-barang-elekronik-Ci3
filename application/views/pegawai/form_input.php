      ...
      <div class="row">
        ...
        <form>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-4">
              <select name="JK" id="" class="form-select" aria-label="Default select example">
          ...
          <button onclick="tombol()" type="submit" class="col-1 offset-3 btn btn-primary" name="submit">Simpan</button>
        </form>
