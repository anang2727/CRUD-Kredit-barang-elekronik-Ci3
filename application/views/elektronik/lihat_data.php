...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h2 class="text-center fw-bold">#BARANG ELEKTRONIK</h2>
      <h1>Dashboard</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <?php echo anchor('elektronik/tambah', 'Tambah', array('class' => ' btn btn-primary mb-3 bi bi-plus btn-sm')); ?>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <td>$no</td> 
            <td>$r->KE</td> 
            <td scope=row>$r->NE</td>
            <td scope=row>$r->MEREK</td>
            <td scope=row>$r->SATUAN</td>
            <td scope=row>$r->JENIS</td>
            <td scope=row>$r->UA</td>
            <td scope=row>$r->LAMA</td>
            <td scope=row>$r->UM</td>
            <td width='2'>" . anchor('elektronik/edit/' . $r->KE, '<i class="bi bi-pencil"></i>', array('class' => 'btn btn-success btn-sm')) . "</td>
            <td width='20'>" . anchor('elektronik/delete/' . $r->KE, '<i class="bi bi-trash"></i>', array('class' => 'btn btn-danger btn-sm')) . "</td>
            <tr>";
                      $no++;
                    } ?>
                  </tbody>
