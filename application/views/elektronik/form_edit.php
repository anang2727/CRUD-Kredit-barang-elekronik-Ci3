...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <?php
        echo form_open('elektronik/edit');
        ?>
        <input type="hidden" value="<?php echo $rec_elektronik['KE'] ?>" name="KE">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h2 class="text-center fw-bold">#ELEKTRONIK</h2>
            <h1>Edit Elektronik</h1>
            <nav>
                <ol class="breadcrumb">
        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <form>
                    ...
                    echo form_open('elektronik/edit');
                    ?>
                    <input type="hidden" value="<?php echo $rec_elektronik['KE'] ?>" name="id">

                    <!-- Kode Elektronik -->
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Kode Elektronik</label>
                        <div class="col-sm-4">
                            <input type="text" name="KE" class="form-control" value="<?php echo $rec_elektronik['KE'] ?>">
                        </div>
                    </div>
                    <!-- Nama Elektronik -->
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Nama Elektronik</label>
                        <div class="col-sm-4">
                            <input type="text" name="NE" class="form-control" value="<?php echo $rec_elektronik['NE'] ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Merek</label>
                        <div class="col-sm-4">
                            <input type="text" name="MEREK" class="form-control" value="<?php echo $rec_elektronik['MEREK'] ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Satuan</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="SATUAN" placeholder="Satuan" value="<?php echo $rec_elektronik['SATUAN'] ?>  ">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Jenis</label>
                        <div class="col-sm-4">
                            <input type="text" name="JENIS" class="form-control" value="<?php echo $rec_elektronik['JENIS'] ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">Uang Angsuran</label>
                        <div class="col-sm-4">
                            <select class="form-select" aria-label="Default select example" name="KA">
                                <?php
                                foreach ($rec_uang_angsuran->result() as $rp) {
                                    echo "<option value='$rp->KA'>$rp->UA</option>";
                                } ?>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <select class="form-select" aria-label="Default select example" name="KL">
                                <?php
                                foreach ($rec_lama_angsuran->result() as $rp) {
                                    echo "<option value='$rp->KL'>$rp->LAMA</option>";
                                } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <select class="form-select" aria-label="Default select example" name="KUA">
                                <?php
                                foreach ($rec_uang_muka->result() as $rp) {
                                    echo "<option value='$rp->KUA'>$rp->UM</option>";
                                } ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row mt-5">
                    <?php echo anchor('elektronik', '<i class="array(btn btn-primary bi bi-arrow-left-square-fill fs-3"></i>') ?>
                </div>
