        ...
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?= base_url() ?>assets/img/Asset 3-100.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="<?= base_url() ?>assets/img/header-100.jpg" class="d-block w-100" alt="...">
                </div>
                ...
                <div class="col-lg-12 m-5 ">
                    <div class="row ">
                        ...
                        <div class="card me-5" style="width: 18rem;">
                            <img class="card-img-top" src="<?= base_url() ?>assets/img/Asset 15-100.jpg" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Kulkas</h5>
                                <p class="card-text">Uang Muka : Rp.120.000</p>
                                <p class="card-text">Uang Angsuran : Rp.200.000</p>
                                <p class="card-text">Lama Angsuran : 1 Tahun</p>
                            </div>
                        </div>
                        <div class="me-5 card" style="width: 18rem;">
                            <img class="card-img-top" src="<?= base_url() ?>assets/img/blender.jpg" alt="Card image cap">
                            <div class="card-body">
                        ...
                        <div class="card me-5" style="width: 18rem;">
                            <img class="card-img-top" src="<?= base_url() ?>assets/img/kipas.jpg" alt="Card image cap">
                            <div class="card-body">
                        ...
                        <div class="card me-5" style="width: 18rem;">
                            <img class="card-img-top mt-5" src="<?= base_url() ?>assets/img/mesin kopi.jpg" alt="Card image cap">
                            <div class="card-body mt-5" style=" padding-top:56px;">
                                <h5 class="card-title">Mesin Kopi</h5>
                                <p class="card-text">Uang Muka : Rp.120.000</p>
                                <p class="card-text">Uang Angsuran : Rp.200.000</p>
                                <p class="card-text">Lama Angsuran : 1 Tahun</p>
                            </div>
                        ...
                        <div class="card me-5" style="width: 18rem;">
                            <img class="card-img-top mt-5" src="<?= base_url() ?>assets/img/mesin.jpg" alt="Card image cap">
                        ...
                        <div class="card me-5" style="width: 18rem;">
                            <img class="card-img-top" src="<?= base_url() ?>assets/img/tv.jpg" alt="Card image cap">
                            <div class="card-body py-5">
                        ...
                        <div class="card me-5" style="width: 18rem;">
                            <img class="card-img-top mt-2" src="<?= base_url() ?>assets/img/Vacuum Cleaner.jpg" alt="Card image cap">
                            <div class="card-body " style=" padding-top:50px;">
                                <h5 class="card-title">Vacum Cleaner</h5>
                                <p class="card-text">Uang Muka : Rp.120.000</p>
                                <p class="card-text">Uang Angsuran : Rp.200.000</p>
                                <p class="card-text">Lama Angsuran : 1 Tahun</p>
                            </div>
                        ...
                        <div class="card me-5" style="width: 18rem;">
                            <img class="card-img-top mt-5" src="<?= base_url() ?>assets/img/oven.jpg" alt="Card image cap">
                        ...
                        <div class="card me-5" style="width: 18rem;">
                            <img class="card-img-top" src="<?= base_url() ?>assets/img/lampi.jpg" alt="Card image cap">
                            <div class="card-body">
                        ...
                        <div class="card me-5" style="width: 18rem;">
                            <img class="card-img-top" src="<?= base_url() ?>assets/img/Asset 13-100.jpg" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Cup Sealter</h5>
                                <p class="card-text">Uang Muka : Rp.120.000</p>
                                <p class="card-text">Uang Angsuran : Rp.200.000</p>
                                <p class="card-text">Lama Angsuran : 1 Tahun</p>
                            </div>
                        ...
                        <div class="card me-5" style="width: 18rem;">
                            <img class="card-img-top" src="<?= base_url() ?>assets/img/Asset 14-100.jpg" alt="Card image cap">
                            <div class="card-body">
                        ...
                        <div class="card me-5" style="width: 18rem;">
                            <img class="card-img-top" src="<?= base_url() ?>assets/img/Asset 9-100.jpg" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">AC Ruangan</h5>
                                <p class="card-text">Uang Muka : Rp.120.000</p>
                                <p class="card-text">Uang Angsuran : Rp.200.000</p>
                                <p class="card-text">Lama Angsuran : 1 Tahun</p>
                            </div>
