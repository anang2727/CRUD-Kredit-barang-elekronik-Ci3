...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h2 class="text-center fw-bold">#DAFTAR ELEKTRONIK</h2>

      <div class="float-end d-flex flex-row">

        <button class="btn btn-danger bi bi-file-earmark-pdf me-3">
          <?php echo anchor('elektronik/pdf', 'Pdf', array('class' => 'mb-3 text-light btn-sm')); ?>
        </button>
        <button class="btn btn-dark bi bi-printer me-3" onclick="window.print();">
          <?php echo anchor('elektronik/cetak', 'Print', array('class' => 'text-light btn-sm')); ?>
        </button>
        <button class="btn btn-success bi bi-file-earmark-excel me-3">
          <?php echo anchor('elektronik/excel', 'Excel', array('class' => 'text-light btn-sm')); ?>
        </button>
        <button class="btn btn-primary bi bi-file-earmark-word me-3">
          <?php echo anchor('elektronik/word', 'Word', array('class' => 'text-light btn-sm')); ?>
        </button>
      </div>
      <h1>Dashboard</h1>
      <nav>
