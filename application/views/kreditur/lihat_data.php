...
<body>
  ...
  <main id="main" class="main">
    ...
    <h2 class="text-center fw-bold">#DAFTAR KREDITUR</h2>

    <div class="pagetitle">
      <h1>Tabel Kreditur</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <?php echo anchor('kreditur/tambah', 'Tambah', array('class' => ' btn btn-primary mb-3 bi bi-plus btn-sm')); ?>
    <!-- <div class="float-end d-flex flex-row">
      ...
      <button class="btn btn-dark bi bi-printer me-3" onclick="window.print();">
        <?php echo anchor('kreditur/cetak', 'Print', array('class' => 'text-light btn-sm')); ?>
      </button>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Daftar Kreditur</h5>
              ...
              <table class="table">
                <thead>
                  <tr>
                    <th scope="col">No</th>
                    <th scope="col">No Kreditur</th>
                    <th scope="col">Nama Kreditur</th>
                    <th scope="col">Alamat kreditur</th>
            ...
            <td>$r->PEKER</td>
            <td>$r->NO_HP</td>
            <td width='2'>" . anchor('kreditur/edit/' . $r->NK, '<i class="bi bi-pencil"></i>', array('class' => 'btn btn-success btn-sm', 'title' => 'Edit ' . $r->NMK)) . "</td>
            <td width='20'>" . anchor('Kreditur/delete/' . $r->NK, '<i class="bi bi-trash"></i>', array('class' => 'btn btn-danger btn-sm', 'title' => 'Hapus ' . $r->NMK)) . "</td>
            <td width='20'>" . anchor('kreditur/detail/' . $r->NK, '<i class="ri-eye-line"></i>', array('class' => 'btn btn-warning btn-sm', 'title' => 'Lihat ' . $r->NMK)) . "</td>
            <tr>";
                    $no++;
                  } ?>
                </tbody>
