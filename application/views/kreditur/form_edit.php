...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h2 class="text-center fw-bold">#KREDITUR</h2>
            <h1>Edit Kreditur</h1>
            <nav>
                <ol class="breadcrumb">
        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <form>
                    ...
                    echo form_open('kreditur/edit');
                    ?>
                    <input type="hidden" value="<?php echo $record['NK'] ?>" name="id">

                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Nama Kreditur</label>
                        <div class="col-sm-4">
                            <input type="text" name="NMK" class="form-control" value="<?php echo $record['NMK'] ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Alamat Kreditur</label>
                        <div class="col-sm-4">
                            <input type="text" name="AK" class="form-control" value="<?php echo $record['AK'] ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Pekerjaan</label>
                        <div class="col-sm-4">
                            <input type="text" name="PEKER" class="form-control" value="<?php echo $record['PEKER'] ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                ...
                <div class="row mt-5">
                    <?php echo anchor('kreditur', '<i class="array(btn btn-primary bi bi-arrow-left-square-fill fs-3"></i>') ?>
                </div>
