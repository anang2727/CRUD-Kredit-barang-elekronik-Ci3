...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <?php
        echo form_open('pengambilan/edit');
        ?>
        <input type="hidden" value="<?php echo $rec_pengambilan['NAM'] ?>" name="NK">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h2 class="text-center fw-bold">#PENGAMBILAN</h2>
            <h1>Edit Pengambilan</h1>
            <nav>
                <ol class="breadcrumb">
        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <form>
                    ...
                    echo form_open('pengambilan/edit');
                    ?>
                    <input type="hidden" value="<?php echo $rec_pengambilan['NAM'] ?>" name="id">
                    <!--  -->
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Nomor Pengambilan</label>
                        <div class="col-sm-4">
                            <input type="text" name="NAM" class="form-control" placeholder="Nomor Ambil" value="<?php echo $rec_pengambilan['NAM'] ?>">
                        </div>
                    </div>
                    <!--  -->
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="TBTP" class="form-control" value="<?php echo $rec_pengambilan['TBTP'] ?>">
                        </div>
                    </div>
                    <!--  -->
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="JML" value="<?php echo $rec_pengambilan['JML'] ?>">
                        </div>
                    </div>
                    <!--  -->
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Ket</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="KET" value="<?php echo $rec_pengambilan['KET'] ?>">
                        </div>
                    </div>
                    <!--  -->
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <select name="NK" class="form-control">
                                ...
                                ?>
                                    <option <?php if ($rec_pengambilan['NK'] == $rp->NK) {
                                                echo 'selected';
                    ...
                    <!--  -->
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Kode Elektronik</label>
                        <div class="col-sm-4">
                            <select name="KE" class="form-control">
                                <?php foreach ($rec_elektronik->result() as $rp) {
                                ?>
                                    <option <?php if ($rec_pengambilan['KE'] == $rp->KE) {
                                                echo 'selected';
                                            } ?> value="<?php echo $rp->KE ?>"><?php echo $rp->KE; ?></option>;
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <!--  -->
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Uang Angsuran</label>
                        <div class="col-sm-4">
                            <select name="KA" class="form-control">
                                <?php foreach ($rec_uang_angsuran->result() as $rp) {
                                ?>
                                    <option <?php if ($rec_pengambilan['KA'] == $rp->KA) {
                                                echo 'selected';
                                            } ?> value="<?php echo $rp->KA ?>"><?php echo $rp->KA; ?></option>;
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <!--  -->
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Uang Muka</label>
                        <div class="col-sm-4">
                            <select name="KUA" class="form-control">
                                <?php foreach ($rec_uang_muka->result() as $rp) {
                                ?>
                                    <option <?php if ($rec_pengambilan['KUA'] == $rp->KUA) {
                                                echo 'selected';
                                            } ?> value="<?php echo $rp->KUA ?>"><?php echo $rp->UM; ?></option>;
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <!-- Lama  Angsuran -->
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Lama Angsuran</label>
                        <div class="col-sm-4">
                            <select name="KL" class="form-control">
                                <?php foreach ($rec_lama_angsuran->result() as $rp) {
                                ?>
                                    <option <?php if ($rec_pengambilan['KL'] == $rp->KL) {
                                                echo 'selected';
                                            } ?> value="<?php echo $rp->KL ?>"><?php echo $rp->LAMA; ?></option>;
                                <?php
                                }
                                ?>
                            </select>
                ...
                <div class="row mt-5">
                    <?php echo anchor('pengambilan', '<i class="array(btn btn-primary bi bi-arrow-left-square-fill fs-3"></i>') ?>
                </div>
