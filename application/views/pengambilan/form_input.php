...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <?php
    echo form_open('pengambilan/tambah');
    ?>
  </header><!-- End Header -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <form>
          ...
          ?>
          <div class="row mb-3">
            <label class="col-sm-2 col-form-label">Nama Kreditur</label>
            <div class="col-sm-4">
              <select class="form-select" aria-label="Default select example" name="NK">
                <?php
                foreach ($rec_kreditur->result() as $rp) {
                  echo "<option value='$rp->NK'>$rp->NMK</option>";
                } ?>
              </select>
            </div>
          </div>
          <div class="row mb-3">
            ...
            <div class="col-sm-4">
              <input type="date" name="TBTP" class="form-control">
            </div>
          </div>
          <div class="row mb-3">
          ...
          <div class="row mb-3">
            <label class="col-sm-2 col-form-label">Kode Elektronik</label>
            <div class="col-sm-4">
              <select class="form-select" aria-label="Default select example" name="KE">
                <?php
                foreach ($rec_elektronik->result() as $rp) {
                  echo "<option value='$rp->KE'>$rp->KE</option>";
                } ?>
              </select>
            </div>
          </div>
          ...
          <button type="submit" onclick="tombol()" class="col-1 offset-3 btn btn-primary" name="submit">Simpan</button>
        </form>
