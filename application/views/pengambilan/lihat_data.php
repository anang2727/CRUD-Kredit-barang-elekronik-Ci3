...
<body>
  ...
  <main id="main" class="main">
    ...
    <?php echo anchor('pengambilan/tambah', 'Tambah', array('class' => ' btn btn-primary mb-3 bi bi-plus btn-sm')); ?>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <td scope=row>$r->JML</td>
            <td scope=row>$r->KET</td>
            <td scope=row>$r->KE</td>
            <td scope=row>$r->KA</td>
            <td scope=row>$r->NMK</td>
            <td scope=row>$r->UM</td>
            <td scope=row>$r->LAMA</td>
            <td width='2'>" . anchor('pengambilan/edit/' . $r->NAM, '<i class="bi bi-pencil"></i>', array('class' => 'btn btn-success btn-sm')) . "</td>
            <td width='20'>" . anchor('pengambilan/delete/' . $r->NAM, '<i class="bi bi-trash"></i>', array('class' => 'btn btn-danger btn-sm')) . "</td>
            <tr>";
                      $no++;
                    } ?>
                  </tbody>
