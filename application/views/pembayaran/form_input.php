...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <?php
        echo form_open('pembayaran/tambah');
        ?>
    </header><!-- End Header -->
            ...
            <div class="row">
                ...
                <form>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="JMA" class="form-control">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <!-- pengambilan  -->
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">Nomor Ambil</label>
                        <div class="col-sm-4">
                            <select class="form-select" aria-label="Default select example" name="NAM">
                                <?php
                                foreach ($rec_pengambilan->result() as $rp) {
                                    echo "<option value='$rp->NAM'>$rp->NAM</option>";
                                } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <select class="form-select" aria-label="Default select example" name="KDP">
                                <?php
                                foreach ($rec_pegawai->result() as $rp) {
                                    echo "<option value='$rp->KDP'>$rp->KDP</option>";
                                } ?>
                            </select>
                        </div>
                    </div>
