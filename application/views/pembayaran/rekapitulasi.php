...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h2 class="text-center fw-bold">#REKAPITULASI PEMBAYARAN</h2>
      <h1>Dashboard</h1>
      <nav>
        <ol class="breadcrumb">
        ...
        <button class="btn mb-4 float-end btn-warning bi bi-printer fw-bold " onclick="window.print();">
      ...
      <div class="row col-12">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Rekapitulasi Pembayaran</h5>
