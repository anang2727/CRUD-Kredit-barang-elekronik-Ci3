        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <form>
                    ...
                    echo form_open('pembayaran/edit');
                    ?>
                    <input type="hidden" value="<?php echo $rec_pembayaran['NB'] ?>" name="id_pembayaran">
                    <!--  -->
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Tanggal Bayar</label>
                        <div class="col-sm-4">
                            <input type="date" name="TBTP" class="form-control" placeholder="Tanggal" value="<?php echo $rec_pembayaran['TBTP'] ?>">
                        </div>
                    </div>
                    <!--  -->
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <select name="KDP" class="form-control">
