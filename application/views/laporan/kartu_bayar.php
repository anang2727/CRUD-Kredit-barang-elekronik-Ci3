...
<body>
    ...
    <main id="main" class="main">
        ...
        <input type="hidden" value="<?php echo $record['NB'] ?>" name="NB">
        ...
        <div class="row">
            <div class="col-xl-5 mt-3">
                ...
                <div class="card py-3">
                    <div class="tab-content pt-2">
                        ...
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <h5 class="card-title fw-bold text-center">KARTU BAYAR ANGSURAN</h5>
                            <p class="text-center">Toko ABC Matang Glumpang Dua</p>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button class="btn btn-warning bi bi-printer me-3" onclick="window.print();">
                        <?php echo anchor('pembayaran', 'Print', array('class' => 'text-dark btn-sm')); ?>
                    </button>
