...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <?php
        echo form_open('uang_angsuran/edit');
        ?>
        <input type="hidden" value="<?php echo $record['KA'] ?>" name="KA">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h2 class="text-center fw-bold">#UANG ANGSURAN</h2>
            <h1>Edit Uang Angsuran</h1>
            <nav>
                <ol class="breadcrumb">
        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <form>
                    ...
                    echo form_open('uang_angsuran/edit');
                    ?>
                    <input type="hidden" value="<?php echo $record['KA'] ?>" name="id">

                    <!-- Kode Elektronik -->
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Jumlah Uang Angsuran</label>
                        <div class="col-sm-4">
                            <input type="text" name="UA" class="form-control" value="<?php echo $record['UA'] ?>">
                        </div>
                    </div>
                ...
                <div class="row mt-5">
                    <?php echo anchor('uang_angsuran', '<i class="array(btn btn-primary bi bi-arrow-left-square-fill fs-3"></i>') ?>
                </div>
