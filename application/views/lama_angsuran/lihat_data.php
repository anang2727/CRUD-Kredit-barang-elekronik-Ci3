...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h2 class="text-center fw-bold">#LAMA ANGSURAN</h2>
      <h1>Dashboard</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <?php echo anchor('lama_angsuran/tambah', 'Tambah', array('class' => ' btn btn-primary mb-3 bi bi-plus btn-sm')); ?>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Lama Angsuran</h5>
            ...
            <td>$no</td>
            <td>$r->KL</td>
            <td scope=row>$r->LAMA</td>
            <td width='2'>" . anchor('lama_angsuran/edit/' . $r->KL, '<i class="bi bi-pencil"></i>', array('class' => 'btn btn-success btn-sm', 'title' => 'Edit ' . $r->LAMA)) . "</td>
            <td width='20'>" . anchor('lama_angsuran/delete/' . $r->KL, '<i class="bi bi-trash"></i>', array('class' => 'btn btn-danger btn-sm', 'title' => 'Hapus ' . $r->LAMA)) . "</td>
            <td width='20'>" . anchor('lama_angsuran/detail/' . $r->KL, '<i class="ri-eye-line"></i>', array('class' => 'btn btn-warning btn-sm', 'title' => 'Lihat' . $r->LAMA)) . "</td>
            <tr>";
                      $no++;
                    } ?>
                  </tbody>
