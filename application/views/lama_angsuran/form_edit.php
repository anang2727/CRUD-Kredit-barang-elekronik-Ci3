...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <?php
        echo form_open('lama_angsuran/edit');
        ?>
    </header><!-- End Header -->
        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <form>
                    ...
                    echo form_open('lama_angsuran/edit');
                    ?>
                    <input type="hidden" value="<?php echo $record['KL'] ?>" name="id">
                    <!--  -->
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Lama Angsuran</label>
                        <div class="col-sm-4">
                            <input inputmode="numeric" class="form-control" type="text" name="LAMA" placeholder="LAMA ANGSURAN" value="<?php echo $record['LAMA'] ?>  ">
                            <!-- pattern="[0-9]*"  -->
                        </div>
                    </div>
                    <!--  -->
                ...
                <div class="row mt-5">
                    <?php echo anchor('lama_angsuran', '<i class="array(btn btn-primary bi bi-arrow-left-square-fill fs-3"></i>') ?>
                </div>
